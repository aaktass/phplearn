...
$total_num_post = mysql_num_rows(mysql_query("SELECT PostID from post"));	
...
<div id="container">
		...
		<div id="content">
			...
			<?php
			$rsPost = mysql_query(
			"SELECT * FROM post LIMIT ".$limit_start.",".$post_per_page."");
			...
			if ($total_row_rsPost > 0){
				...
				if (@$_GET['secim']=='hatalikategori'){	
				echo "<h1>Hatalı Kategori Seçimi</h1>";
				}
